...
#INCLUDE       	<OPERATION.INC>
	...
	PUBLIC         	_freeDATA
	PUBLIC         	_set_heap
	PUBLIC         	_set_heapDATA
	PUBLIC         	_get_heap_status
	PUBLIC         	_init_heap
	PUBLIC         	_heap_area
	PUBLIC         	__malloc
	PUBLIC         	__mallocDATA
...
SECTION1D__ae_projects_Compiler_Library_Source_stdlib_stdlib_stdlib_97_memory_memory_c_STATIC	UNINTIAL       	0		; Bank 0
	ORG            	0X9D		; Bank 0
_heap_area	RSEG           	0X2		; Bank 0
	END
